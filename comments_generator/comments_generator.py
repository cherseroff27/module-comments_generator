...
class CommentsGenerator:
    ...
    def generate_prompt(gender_flag, comments_amount):
        ...
        prompt_text = (
            f"Мне нужно, чтобы ты написал комментарии для статьи:\n\n"
            f"Комментарии должны быть реалистичными, как будто их написали реальные люди, "
            f"разного возраста, со своими привычками в комментировании статей.\n"
            f"(Критические/Поддерживающие/Сравнительные/Философские/Юмористические/Эмоциональные/Информативные и т.д.)."
